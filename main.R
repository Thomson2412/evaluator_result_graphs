...
p_plot <- function (p_data, p_title, p_colors){
...
# Create plots
pp1 <- p_plot(p1, "William Merritt Chase - The Olive Grove - 1910\nQuestions combined", model_colors)
pp2 <- p_plot(p2, "Paul Delvaux - The Viaducto\nQuestions combined", model_colors)
pp3 <- p_plot(p3,  "Claude Monet - Water Lilies - 1917\nQuestions combined", model_colors)
pp4 <- p_plot(p4, "Valentin Serov - Iphigenia in Tauris - 1893\nQuestions combined", model_colors)
pp5 <- p_plot(p5, "Charge of the scots greys at waterloo\nQuestions combined", model_colors)
pp6 <- p_plot(p6, "Alfred Sisley - Snow at Louveciennes - 1878\nQuestions combined", model_colors)
pp7 <- p_plot(p7, "Enrique Simonet - El barbero del zoco - 1897\nQuestions combined", model_colors)
pp8 <- p_plot(p8, "John Lavery - The Fairy Fountain\nQuestions combined", model_colors)
...
pp_width <- 6
pp_height <- 6
ggsave("plots/pq4.png", plot = pq4, width = pp_width, height = pp_height)
ggsave("plots/pq5.png", plot = pq5, width = pp_width, height = pp_height)
ggsave("plots/pq6.png", plot = pq6, width = pp_width, height = pp_height)

ggsave("plots/pp1q4.png", plot = pp1q4, width = pp_width, height = pp_height)
ggsave("plots/pp2q4.png", plot = pp2q4, width = pp_width, height = pp_height)
ggsave("plots/pp3q4.png", plot = pp3q4, width = pp_width, height = pp_height)
ggsave("plots/pp4q4.png", plot = pp4q4, width = pp_width, height = pp_height)
ggsave("plots/pp5q4.png", plot = pp5q4, width = pp_width, height = pp_height)
ggsave("plots/pp6q4.png", plot = pp6q4, width = pp_width, height = pp_height)
ggsave("plots/pp7q4.png", plot = pp7q4, width = pp_width, height = pp_height)
ggsave("plots/pp8q4.png", plot = pp8q4, width = pp_width, height = pp_height)

ggsave("plots/pp1q5.png", plot = pp1q5, width = pp_width, height = pp_height)
ggsave("plots/pp2q5.png", plot = pp2q5, width = pp_width, height = pp_height)
ggsave("plots/pp3q5.png", plot = pp3q5, width = pp_width, height = pp_height)
ggsave("plots/pp4q5.png", plot = pp4q5, width = pp_width, height = pp_height)
ggsave("plots/pp5q5.png", plot = pp5q5, width = pp_width, height = pp_height)
ggsave("plots/pp6q5.png", plot = pp6q5, width = pp_width, height = pp_height)
ggsave("plots/pp7q5.png", plot = pp7q5, width = pp_width, height = pp_height)
ggsave("plots/pp8q5.png", plot = pp8q5, width = pp_width, height = pp_height)

ggsave("plots/pp1q6.png", plot = pp1q6, width = pp_width, height = pp_height)
ggsave("plots/pp2q6.png", plot = pp2q6, width = pp_width, height = pp_height)
ggsave("plots/pp3q6.png", plot = pp3q6, width = pp_width, height = pp_height)
ggsave("plots/pp4q6.png", plot = pp4q6, width = pp_width, height = pp_height)
ggsave("plots/pp5q6.png", plot = pp5q6, width = pp_width, height = pp_height)
ggsave("plots/pp6q6.png", plot = pp6q6, width = pp_width, height = pp_height)
ggsave("plots/pp7q6.png", plot = pp7q6, width = pp_width, height = pp_height)
ggsave("plots/pp8q6.png", plot = pp8q6, width = pp_width, height = pp_height)
